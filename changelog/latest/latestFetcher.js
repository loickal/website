fetch("/changelog/data/json/changelog.json")
    ...
    .then(t => {
        ...
        var mainobject = document.getElementsByClassName("mainwrapper")[0];

        if (mainobject != null) {
            if (latestObject == null) {
                createElementWithContent("hero", mainobject, "div", `<h1 class="hero__title" style="font-size: 350%; color: var(--accent-color);">Error</h1>
            ...
            createElementWithContent("hero", mainobject, "div", `<h1 class="hero__title" style="font-size: 350%;">Downloading latest...</h1>
